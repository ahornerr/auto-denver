    ...
    protected void onHandleIntent(Intent intent) {
        if (intent != null) {
            ...
            if (ACTION_EXTRACT.equals(action)) {
                ...
                handleModelExtraction(modelName, modelPath);
            }
        }
    }

    private void handleModelExtraction(final String modelName, final String modelPath) {
        ...
        try {
            ...
            zipInputStream = new ZipInputStream(getAssets().open(modelPath));
            ZipEntry zipEntry;
